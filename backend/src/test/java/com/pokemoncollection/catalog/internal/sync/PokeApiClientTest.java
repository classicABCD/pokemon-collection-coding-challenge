...
class PokeApiClientTest {
    ...
    void idIsParsedFromResourceUrl() {
        assertThat(PokeApiClient.idFromUrl("https://pokeapi.co/api/v2/pokemon/25/")).isEqualTo(25);
        assertThat(PokeApiClient.idFromUrl("https://pokeapi.co/api/v2/pokemon/10001")).isEqualTo(10001);
    }

    @Test
    void onlyHttpsSpriteUrlsAreAccepted() {
        assertThat(PokeApiClient.httpsOrNull("https://raw.githubusercontent.com/25.png")).isNotNull();
